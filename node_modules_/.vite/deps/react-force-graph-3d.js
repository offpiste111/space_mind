import {
  ...
  _setPrototypeOf,
  require_prop_types
} from "./chunk-LWEYQQ6D.js";
import {
  dispatch_default,
  quadtree,
  timer
} from "./chunk-Z3DDY6LY.js";
import {
  require_react
...
function add_default2(d) {
  ...
  return add2(this.cover(x2, y2, z2), x2, y2, z2, d);
}
function add2(tree, x2, y2, z2, d) {
...
function cover_default2(x2, y2, z2) {
...
function find_default2(x2, y2, z2, radius) {
...
function octree(nodes, x2, y2, z2) {
  var tree = new Octree(x2 == null ? defaultX2 : x2, y2 == null ? defaultY : y2, z2 == null ? defaultZ : z2, NaN, NaN, NaN, NaN, NaN, NaN);
  return nodes == null ? tree : tree.addAll(nodes);
}
...
function fromKapsule(kapsule) {
  ...
  var FromKapsule = function(_baseClass) {
    ...
    function FromKapsule2() {
      ...
      _this.__kapsuleInstance = kapsule().apply(void 0, [].concat(_toConsumableArray5(initKapsuleWithSelf ? [_assertThisInitialized(_this)] : []), args));
      return _this;
    }
