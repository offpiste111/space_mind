...
const HtmlNodeComponent: React.FC<HtmlNodeComponentProps> = ({ node }) => {
  ...
  // SVGアイコンの再現
  const LinkIcon = () => (
    <svg style={{ position: 'absolute', left: `${20 * SCALE}px`, top: '50%', transform: 'translateY(-50%)', width: `${25 * SCALE}px`, height: `${25 * SCALE}px` }} viewBox="0 0 24 24" fill="none" stroke={themeColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
